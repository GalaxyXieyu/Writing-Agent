...
template_refresher = {"titleName": RunnablePassthrough(),"writingRequirement": RunnablePassthrough(),"original_template": RunnablePassthrough()} | template_refresh_prompt | llm | extract_template_generate
